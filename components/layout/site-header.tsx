    ...
    >
      ...
      >
        <a
          ...
          aria-label="Dipto Karmakar — return to top"
        ...
        >
          ...
          <span aria-hidden="true">Dipto</span>
        </a>
      ...
      >
        <ul className="flex list-none flex-col px-6 py-4">
          {links.map((link) => (
            <li
              key={link.href}
        ...
        <div className="px-6 pb-4">
          <a
            href="#contact"
            onClick={() => setOpen(false)}
            className="group inline-flex w-full items-center justify-center gap-1.5 rounded-md bg-accent-cyan px-4 py-2.5 font-mono text-sm font-medium text-accent-cyan-foreground"
          >
            Get in touch
